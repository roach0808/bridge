...
| 2026-09-25 | The Tasks page is **one table** — Owner, Start, End date, Description, Status — sorted and filtered by its own headings, with the quadrants a button away. It replaced four tabbed views on the day they were built: the model underneath is right, the screen was too much |
