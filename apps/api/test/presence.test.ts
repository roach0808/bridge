...
describe('presence', () => {
  ...
  it('GET /presence answers per role', async () => {
    ...
    expect(list).toEqual([{ userId: fx.founder.id, status: 'online', lastSeenAt: null }]);
