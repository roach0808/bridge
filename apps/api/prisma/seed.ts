...
async function main() {
  ...
  const tasks: Array<{
    ...
    // column of hundreds. Each is a 30-day task counting both ends, a third, a
    // half and two thirds through: 56, 75 and 89.
    { owner: pixel, by: atlas, title: 'Build the Q4 expert pipeline', startBy: -9, completeBy: 20, deliverable: '200 vetted experts across the P1 platforms' },
    { owner: sprout, by: atlas, title: 'Rewrite the outreach templates', startBy: -14, completeBy: 15, urgency: 'can_wait' },
    { owner: mango, by: beacon, title: 'Reconcile the platform invoices', startBy: -19, completeBy: 10, deliverable: 'Every invoice matched to a call' },
  ];
  let taskPosition = 0;
